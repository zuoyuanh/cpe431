...
public class ARMMoveCode extends ARMCode
{
   ...
   public String toString(){
      String opr = "";
      if (operand instanceof LLVMRegisterType) opr = ((LLVMRegisterType)operand).toString();
      else if (operand instanceof LLVMPrimitiveType)  opr = "#"+ ((LLVMPrimitiveType)operand).getValueRep();
