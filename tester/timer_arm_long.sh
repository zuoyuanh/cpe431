...
do
   ...
   time $(./$filename.out < ../../benchmarks/$filename/input.longer > $filename.myout.longer) 
   echo "--------------"
   echo "time for non-optimized ARM: " 
   time $(./$filename.no_o.out < ../../benchmarks/$filename/input.longer > $filename.myout.longer) 
   echo "--------------"
   echo "time for optimized GCC: " 
   time $(./$filename.gcc.out < ../../benchmarks/$filename/input.longer > $filename.myout.longer) 
   echo "--------------"
   echo "time for non-optimized GCC: " 
   time $(./$filename.gcc.no_o.out < ../../benchmarks/$filename/input.longer > $filename.myout.longer) 
   echo "--------------"
